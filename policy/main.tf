...
resource "azurerm_subscription_policy_assignment" "initiative_mandatory_tags_assignment" {
  ...
  non_compliance_message {
    content = "Subscription and Resource Group must have all mandatory tags: BusinessOwner, Environment, CompanyCode, Scm, DataClassification, BusinessCriticality, CostCenter, Project, BusinessRequest."
  }
} 